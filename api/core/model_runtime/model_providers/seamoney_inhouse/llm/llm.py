...
from core.model_runtime.model_providers.seamoney_inhouse._common import _CommonSeaMoney
from core.model_runtime.utils import helper

logger = logging.getLogger(__name__)


class SeaMoneyLargeLanguageModel(_CommonSeaMoney, LargeLanguageModel):
    """
